...
public class Grain {
    ...
    public void init(String iv, String key) {
      ...
      String key_result = this.stringToBinary(key);
        ...
        //mengisi jika panjang iv tidak sampai 54
    ...
    public String decrypt(String keystream, String cipher) {
        ...
        System.out.println("tes plain "+plain_binary);
        System.out.println("Dekripsi adalah= "+plain_binary);
   ...
   //     int decimal = Integer.parseInt(hasilE, 2);
    ...
    public String hasilD() {
       /* int decimal = Integer.parseInt(hasilD, 2);
        String hexStr = Integer.toString(decimal, 16);*/
        return hasilD;
    }
}
