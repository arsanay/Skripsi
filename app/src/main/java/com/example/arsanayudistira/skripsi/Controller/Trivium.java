...
/**
 * Created by Arsana Yudistira on 3/2/2018.
 */




public class Trivium2 {
    ...
    public Trivium2(String key,String iv,String plain) {
    ...
    public String encrypt(String input){
        ...
        System.out.println("keccak-224 = " + keccak.getHash(cipher, KECCAK_224));
...
//        Trivium2 tr = new Trivium2("skripsi","arsana","paslon1");
//
//    }
